return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>fg', builtin.live_grep, { desc = '[F]ind in by [G]rep' })
    vim.keymap.set('n', '<C-s>', builtin.live_grep, { desc = '[F]ind in by [G]rep' })
    ...
    end, { desc = '[F]ind in [/] in Open Files' })
